export default {
  ...
  maintenance: {
    ...
    logTab: 'Journal',
    logDescription: 'Consulter les opérations d’entretien terminées, les réparations et les pannes',
    allPrinters: 'Toutes les imprimantes',
    filterByPrinter: 'Filtrer par imprimante',
    filterByType: 'Filtrer par type',
    allLogEntries: 'Toutes les entrées',
    scheduledLogs: 'Planifiée',
    unscheduledLogs: 'Non planifiée',
    addLogEntry: 'Ajouter une entrée au journal',
    editLogEntry: 'Modifier l’entrée du journal',
    noLogEntries: 'Aucune entrée dans le journal de maintenance',
    manualEntry: 'Entrée manuelle',
    scheduledEntry: 'Tâche planifiée',
    recordedBy: 'Enregistré par',
    updatedBy: 'Dernière modification par',
    printer: 'Imprimante',
    selectPrinter: 'Sélectionner une imprimante',
    entryTitle: 'Titre',
    entryTitlePlaceholder: 'p. ex. Extrudeur remplacé',
    occurredAt: 'Date et heure',
    recordPrintHours: 'Heures d’impression au moment de l’entretien (facultatif)',
    notes: 'Notes',
    saveLogEntry: 'Enregistrer l’entrée',
    loadMore: 'Charger plus',
    logEntryCreated: 'Entrée de maintenance créée',
    logEntryUpdated: 'Entrée de maintenance mise à jour',
    logEntryDeleted: 'Entrée de maintenance supprimée',
    deleteLogEntryTitle: 'Supprimer l’entrée de maintenance ?',
    deleteLogEntryMessage: 'Supprimer définitivement « {{title}} » ?',
    // Status
  ...
  settings: {
    ...
    manageInventoryDescription: 'Créer, modifier et supprimer des bobines et des entrées d\'inventaire.',
    ...
    cameraNativeOnly: 'Caméras intégrées de l\'imprimante',
    cameraNativeOnlyDescription: 'La vue en direct et les instantanés utilisent la caméra intégrée de chaque imprimante Bambu prise en charge. Les caméras externes et USB ne sont pas prises en charge.',
    nativeCamera: 'Caméra intégrée',
    ...
    oidc: {
      ...
      form: {
        ...
        defaultGroup: 'Groupe par défaut',
        defaultGroupDesc: 'Groupe attribué aux utilisateurs créés automatiquement. Laisser vide pour les créer sans permissions de groupe.',
        defaultGroupNone: 'Aucun (aucune permission)',
  ...
  printModal: {
    ...
    queueItemUpdated: 'Élément de la file mis à jour',
    printerSelector: {
      reRead: 'Relire',
      stateOffline: 'Hors ligne',
      statePrinting: 'Impression',
      ...
      noActivePrinters: 'Aucune imprimante active disponible',
      anyModel: 'N\'importe quelle {{model}}',
      anyModelGeneric: 'N\'importe quel modèle',
      specificPrinter: 'Imprimante spécifique',
      targetModel: 'Modèle cible',
      selectModel: 'Sélectionnez un modèle...',
      locationFilter: 'Filtre d\'emplacement (facultatif)',
      anyLocation: 'N\'importe quel emplacement',
      schedulerAssigns: 'Le planificateur attribuera la première imprimante {{model}} libre',
      schedulerAssignsInLocation: 'Le planificateur attribuera la première imprimante {{model}} libre à {{location}}',
      selectPrinters: 'Sélectionnez des imprimantes',
      ...
      inactive: '(désactivée)',
      unknownModel: 'Modèle inconnu',
      matched: '({{matched}}/{{total}} correspondances)',
      auto: 'Auto',
      ...
      showAll: 'tout afficher',
      showOnlyModel: 'Afficher uniquement les imprimantes {{model}}',
      selectAtLeastOnePrinter: 'Sélectionnez au moins une imprimante',
