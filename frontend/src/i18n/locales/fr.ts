export default {
  ...
  printModal: {
    ...
    helpAsap: 'L\'impression démarrera dès que l\'imprimante sera inactive.',
    ...
    helpQueue: 'L\'impression sera préparée mais ne démarrera pas automatiquement. Utilisez le bouton Démarrer pour la libérer dans la file.',
    leftNozzle: 'G',
    rightNozzle: 'D',
