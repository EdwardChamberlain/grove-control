export default {
  ...
  maintenance: {
    ...
    settingsTab: '설정',
    logTab: '로그',
    logDescription: '완료된 유지보수, 수리 및 고장을 확인합니다',
    allPrinters: '모든 프린터',
    filterByPrinter: '프린터로 필터링',
    filterByType: '유형으로 필터링',
    allLogEntries: '모든 항목',
    scheduledLogs: '예약됨',
    unscheduledLogs: '예약되지 않음',
    addLogEntry: '로그 항목 추가',
    editLogEntry: '로그 항목 편집',
    noLogEntries: '유지보수 로그 항목이 없습니다',
    manualEntry: '수동 기록',
    scheduledEntry: '예약된 작업',
    recordedBy: '기록자',
    updatedBy: '마지막 편집자',
    printer: '프린터',
    selectPrinter: '프린터 선택',
    entryTitle: '제목',
    entryTitlePlaceholder: '예: 익스트루더 교체',
    occurredAt: '발생 시간',
    recordPrintHours: '유지보수 시 인쇄 시간(선택 사항)',
    notes: '메모',
    saveLogEntry: '로그 항목 저장',
    loadMore: '더 불러오기',
    logEntryCreated: '유지보수 로그 항목이 생성되었습니다',
    logEntryUpdated: '유지보수 로그 항목이 업데이트되었습니다',
    logEntryDeleted: '유지보수 로그 항목이 삭제되었습니다',
    deleteLogEntryTitle: '유지보수 로그 항목을 삭제하시겠습니까?',
    deleteLogEntryMessage: '"{{title}}"을(를) 영구적으로 삭제하시겠습니까?',
  ...
  settings: {
    ...
    manageInventoryDescription: '스풀 및 재고 레코드 생성, 업데이트 및 삭제.',
    libraryBadge: '라이브러리',
    inventoryBadge: '재고',
    ...
    cameraNativeOnly: '프린터 내장 카메라',
    cameraNativeOnlyDescription: '라이브 뷰와 스냅샷에는 지원되는 각 Bambu 프린터에 내장된 카메라가 사용됩니다. 외부 카메라와 USB 카메라는 지원되지 않습니다.',
    nativeCamera: '내장 카메라',
  ...
  printModal: {
    ...
    queueItemUpdated: '대기열 항목이 업데이트되었습니다',
    printerSelector: {
      reRead: '다시 읽기',
      stateOffline: '오프라인',
      statePrinting: '출력 중',
      ...
      stateFinished: '완료',
      stateFailed: '실패',
      noPrinters: '사용 가능한 프린터가 없습니다',
      noActivePrinters: '사용 가능한 활성 프린터가 없습니다',
      anyModel: '모든 {{model}}',
      anyModelGeneric: '모든 모델',
      specificPrinter: '특정 프린터',
      targetModel: '대상 모델',
      selectModel: '모델 선택...',
      locationFilter: '위치 필터 (선택 사항)',
      anyLocation: '모든 위치',
      schedulerAssigns: '스케줄러가 처음으로 사용 가능한 {{model}} 프린터에 할당합니다',
      schedulerAssignsInLocation: '스케줄러가 {{location}}에서 처음으로 사용 가능한 {{model}} 프린터에 할당합니다',
      selectPrinters: '프린터 선택',
      printersSelected_one: '프린터 {{count}}대 선택됨',
      printersSelected_other: '프린터 {{count}}대 선택됨',
      selectAll: '모두 선택',
      clear: '지우기',
      inactive: '(비활성)',
      unknownModel: '알 수 없는 모델',
      matched: '({{matched}}/{{total}} 일치)',
      auto: '자동',
      hiddenPrinters_one: '다른 프린터 {{count}}대 숨김 (다른 모델) —',
      hiddenPrinters_other: '다른 프린터 {{count}}대 숨김 (다른 모델) —',
      showAll: '모두 표시',
      showOnlyModel: '{{model}} 프린터만 표시',
