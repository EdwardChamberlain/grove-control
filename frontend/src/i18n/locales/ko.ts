export default {
  ...
  printModal: {
    ...
    helpAsap: '작업을 대기열 맨 위에 추가하고 사용 가능한 프린터가 유휴 상태가 되면 시작합니다.',
    helpSchedule: '예약된 시간에 프린터가 유휴 상태이면 인쇄를 시작합니다. 사용 중이면 프린터가 사용 가능해질 때까지 기다립니다.',
    helpQueue: '작업을 대기열 뒤에 추가합니다.',
    leftNozzle: 'L',
    rightNozzle: 'R',
