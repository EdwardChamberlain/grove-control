export default {
  ...
  maintenance: {
    ...
    selectPrinter: '選擇印表機',
    entryTitle: '標題',
    entryTitlePlaceholder: '例如：更換擠出機',
    occurredAt: '發生時間',
    recordPrintHours: '維護時的列印小時數（可選）',
    notes: '備註',
    saveLogEntry: '儲存日誌記錄',
    loadMore: '載入更多',
    logEntryCreated: '維護日誌記錄已建立',
    logEntryUpdated: '維護日誌記錄已更新',
    logEntryDeleted: '維護日誌記錄已刪除',
    deleteLogEntryTitle: '刪除維護日誌記錄？',
    deleteLogEntryMessage: '確定要永久刪除「{{title}}」嗎？',
    // Status
  ...
  settings: {
    ...
    manageInventoryDescription: '建立、更新與刪除耗材盤與庫存記錄。',
    libraryBadge: '資料庫',
    inventoryBadge: '庫存',
    manageProjects: '管理專案',
    ...
    cameraNativeOnly: '印表機內建攝影機',
    cameraNativeOnlyDescription: '即時畫面和快照會使用每台支援的 Bambu 印表機內建攝影機。不支援外部攝影機和 USB 攝影機。',
    nativeCamera: '內建攝影機',
    ...
    oidc: {
      ...
      form: {
        ...
        defaultGroup: '預設群組',
        defaultGroupDesc: '分配給自動建立使用者的群組。留空即可建立沒有群組權限的使用者。',
        defaultGroupNone: '無（無權限）',
        autologin: '自動登入',
  ...
  printModal: {
    ...
    printerSelector: {
      ...
      stateFailed: '失敗',
      noPrinters: '沒有可用的印表機',
      noActivePrinters: '沒有可用的啟用中印表機',
      anyModel: '任意 {{model}}',
      anyModelGeneric: '任意型號',
      specificPrinter: '指定印表機',
      targetModel: '目標型號',
      selectModel: '選擇型號...',
      locationFilter: '位置篩選（選填）',
      anyLocation: '任意位置',
      schedulerAssigns: '排程器將指派給第一台閒置的 {{model}} 印表機',
      schedulerAssignsInLocation: '排程器將指派給 {{location}} 中第一台閒置的 {{model}} 印表機',
      ...
      inactive: '（未啟用）',
      unknownModel: '未知型號',
      matched: '（{{matched}}/{{total}} 已符合）',
      auto: '自動',
      hiddenPrinters_one: '已隱藏 {{count}} 台其他印表機（型號不同）—',
      hiddenPrinters_other: '已隱藏 {{count}} 台其他印表機（型號不同）—',
      showAll: '全部顯示',
      showOnlyModel: '僅顯示 {{model}} 印表機',
