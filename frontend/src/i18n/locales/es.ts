export default {
  ...
  maintenance: {
    ...
    settingsTab: 'Ajustes',
    logTab: 'Registro',
    logDescription: 'Revisar mantenimientos completados, reparaciones y fallos',
    allPrinters: 'Todas las impresoras',
    filterByPrinter: 'Filtrar por impresora',
    filterByType: 'Filtrar por tipo',
    allLogEntries: 'Todas las entradas',
    scheduledLogs: 'Programado',
    unscheduledLogs: 'No programado',
    addLogEntry: 'Añadir entrada al registro',
    editLogEntry: 'Editar entrada del registro',
    noLogEntries: 'No hay entradas en el registro de mantenimiento',
    manualEntry: 'Registro manual',
    scheduledEntry: 'Tarea programada',
    recordedBy: 'Registrado por',
    updatedBy: 'Última edición de',
    printer: 'Impresora',
    selectPrinter: 'Seleccionar una impresora',
    entryTitle: 'Título',
    entryTitlePlaceholder: 'p. ej., Extrusor reemplazado',
    occurredAt: 'Fecha y hora',
    recordPrintHours: 'Horas de impresión en el mantenimiento (opcional)',
    notes: 'Notas',
    saveLogEntry: 'Guardar entrada',
    loadMore: 'Cargar más',
    logEntryCreated: 'Entrada de mantenimiento creada',
    logEntryUpdated: 'Entrada de mantenimiento actualizada',
    logEntryDeleted: 'Entrada de mantenimiento eliminada',
    deleteLogEntryTitle: '¿Eliminar la entrada de mantenimiento?',
    deleteLogEntryMessage: '¿Eliminar "{{title}}" permanentemente?',
    // Status
  ...
  settings: {
    ...
    manageInventoryDescription: 'Crear, actualizar y eliminar bobinas y registros de inventario.',
    ...
    cameraNativeOnly: 'Cámaras integradas de la impresora',
    cameraNativeOnlyDescription: 'La vista en directo y las instantáneas utilizan la cámara integrada en cada impresora Bambu compatible. No se admiten cámaras externas ni USB.',
    nativeCamera: 'Cámara integrada',
    ...
    oidc: {
      ...
      form: {
        ...
        defaultGroup: 'Grupo predeterminado',
        defaultGroupDesc: 'Grupo asignado a los usuarios creados automáticamente. Déjalo vacío para crearlos sin permisos derivados de grupos.',
        defaultGroupNone: 'Ninguno (sin permisos)',
  ...
  fileManager: {
    ...
    singleFilePrompt: 'Suelte un archivo aquí',
    selectOneFile: 'Seleccione un archivo a la vez',
  ...
  // Print modal
  printModal: {
    directUploadRetained: 'El archivo permanecerá en el Administrador de archivos porque se usa para varias impresiones.',
    variants: {
    ...
    queueItemUpdated: 'Elemento de la cola actualizado',
    printerSelector: {
      reRead: 'Releer',
      stateOffline: 'Desconectada',
      statePrinting: 'Imprimiendo',
      ...
      noActivePrinters: 'No hay impresoras activas disponibles',
      anyModel: 'Cualquier {{model}}',
      anyModelGeneric: 'Cualquier modelo',
      ...
      schedulerAssigns: 'El programador asignará la primera impresora {{model}} inactiva disponible',
      schedulerAssignsInLocation: 'El programador asignará la primera impresora {{model}} inactiva disponible en {{location}}',
      selectPrinters: 'Selecciona impresoras',
      ...
      inactive: '(inactiva)',
      unknownModel: 'Modelo desconocido',
      matched: '({{matched}}/{{total}} coinciden)',
      auto: 'Automático',
      hiddenPrinters_one: '{{count}} impresora más oculta (otro modelo) —',
      hiddenPrinters_other: '{{count}} impresoras más ocultas (otro modelo) —',
      showAll: 'mostrar todas',
      showOnlyModel: 'Mostrar solo impresoras {{model}}',
      selectAtLeastOnePrinter: 'Selecciona al menos una impresora',
      selectTargetModel: 'Selecciona un modelo de impresora de destino',
    },
  },
