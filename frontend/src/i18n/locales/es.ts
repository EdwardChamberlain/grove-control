export default {
  ...
  printModal: {
    ...
    helpAsap: 'La impresión comenzará en cuanto la impresora esté inactiva.',
    ...
    helpQueue: 'La impresión quedará preparada, pero no comenzará automáticamente. Use el botón Iniciar para liberarla a la cola.',
    leftNozzle: 'I',
    rightNozzle: 'D',
