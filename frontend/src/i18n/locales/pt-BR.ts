export default {
  ...
  printModal: {
    ...
    helpAsap: 'A impressão começará assim que a impressora estiver ociosa.',
    ...
    helpQueue: 'A impressão ficará preparada, mas não começará automaticamente. Use o botão Iniciar para liberá-la para a fila.',
    leftNozzle: 'L',
    rightNozzle: 'R',
