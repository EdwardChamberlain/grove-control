export default {
  ...
  maintenance: {
    ...
    logTab: 'Registro',
    logDescription: 'Revise manutenções concluídas, reparos e falhas',
    allPrinters: 'Todas as impressoras',
    filterByPrinter: 'Filtrar por impressora',
    filterByType: 'Filtrar por tipo',
    allLogEntries: 'Todas as entradas',
    scheduledLogs: 'Programado',
    unscheduledLogs: 'Não programado',
    addLogEntry: 'Adicionar entrada ao registro',
    editLogEntry: 'Editar entrada do registro',
    noLogEntries: 'Nenhuma entrada no registro de manutenção',
    manualEntry: 'Registro manual',
    scheduledEntry: 'Tarefa programada',
    recordedBy: 'Registrado por',
    updatedBy: 'Última edição por',
    printer: 'Impressora',
    selectPrinter: 'Selecionar uma impressora',
    entryTitle: 'Título',
    entryTitlePlaceholder: 'ex.: Extrusor substituído',
    occurredAt: 'Data e hora',
    recordPrintHours: 'Horas de impressão na manutenção (opcional)',
    notes: 'Observações',
    saveLogEntry: 'Salvar entrada',
    loadMore: 'Carregar mais',
    logEntryCreated: 'Entrada de manutenção criada',
    logEntryUpdated: 'Entrada de manutenção atualizada',
    logEntryDeleted: 'Entrada de manutenção excluída',
    deleteLogEntryTitle: 'Excluir entrada de manutenção?',
    deleteLogEntryMessage: 'Excluir "{{title}}" permanentemente?',
    // Status
  ...
  settings: {
    ...
    manageInventoryDescription: 'Criar, atualizar e excluir bobinas e registros de estoque.',
    ...
    cameraNativeOnly: 'Câmeras integradas da impressora',
    cameraNativeOnlyDescription: 'A visualização ao vivo e as capturas usam a câmera integrada em cada impressora Bambu compatível. Câmeras externas e USB não são compatíveis.',
    nativeCamera: 'Câmera integrada',
    ...
    oidc: {
      ...
      form: {
        ...
        defaultGroup: 'Grupo padrão',
        defaultGroupDesc: 'Grupo atribuído aos usuários criados automaticamente. Deixe vazio para criá-los sem permissões derivadas de grupos.',
        defaultGroupNone: 'Nenhum (sem permissões)',
  ...
  printModal: {
    ...
    useOriginalFilament: 'Usar perfil fatiado',
    ...
    queueItemUpdated: 'Item da fila atualizado',
    printerSelector: {
      reRead: 'Reler',
      stateOffline: 'Offline',
      statePrinting: 'Imprimindo',
      statePreparing: 'Preparando',
      statePaused: 'Pausada',
      stateIdle: 'Ociosa',
      stateFinished: 'Concluída',
      stateFailed: 'Falhou',
      noPrinters: 'Nenhuma impressora disponível',
      noActivePrinters: 'Nenhuma impressora ativa disponível',
      anyModel: 'Qualquer {{model}}',
      anyModelGeneric: 'Qualquer modelo',
      ...
      schedulerAssigns: 'O agendador atribuirá à primeira impressora {{model}} ociosa disponível',
      schedulerAssignsInLocation: 'O agendador atribuirá à primeira impressora {{model}} ociosa disponível em {{location}}',
      selectPrinters: 'Selecione impressoras',
      ...
      inactive: '(inativa)',
      unknownModel: 'Modelo desconhecido',
      matched: '({{matched}}/{{total}} correspondentes)',
      auto: 'Auto',
      ...
      showOnlyModel: 'Mostrar apenas impressoras {{model}}',
      selectAtLeastOnePrinter: 'Selecione pelo menos uma impressora',
