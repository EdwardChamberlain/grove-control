export default {
  ...
  maintenance: {
    ...
    selectPrinter: '选择打印机',
    entryTitle: '标题',
    entryTitlePlaceholder: '例如：更换挤出机',
    occurredAt: '发生时间',
    recordPrintHours: '维护时的打印小时数（可选）',
    notes: '备注',
    saveLogEntry: '保存日志记录',
    loadMore: '加载更多',
    logEntryCreated: '维护日志记录已创建',
    logEntryUpdated: '维护日志记录已更新',
    logEntryDeleted: '维护日志记录已删除',
    deleteLogEntryTitle: '删除维护日志记录？',
    deleteLogEntryMessage: '确定要永久删除“{{title}}”吗？',
    // Status
  ...
  settings: {
    ...
    manageInventoryDescription: '创建、更新和删除耗材盘以及库存记录。',
    libraryBadge: '资料库',
    inventoryBadge: '库存',
    manageProjects: '管理项目',
    ...
    cameraNativeOnly: '打印机内置摄像头',
    cameraNativeOnlyDescription: '实时画面和快照使用每台受支持 Bambu 打印机内置的摄像头。不支持外部摄像头和 USB 摄像头。',
    nativeCamera: '内置摄像头',
    ...
    oidc: {
      ...
      form: {
        ...
        defaultGroup: '默认组',
        defaultGroupDesc: '分配给自动创建用户的组。留空可创建没有组权限的用户。',
        defaultGroupNone: '无（无权限）',
        autologin: '自动登录',
  ...
  printModal: {
    ...
    printerSelector: {
      ...
      stateFailed: '失败',
      noPrinters: '没有可用的打印机',
      noActivePrinters: '没有可用的活动打印机',
      anyModel: '任意 {{model}}',
      anyModelGeneric: '任意型号',
      specificPrinter: '指定打印机',
      targetModel: '目标型号',
      selectModel: '选择型号...',
      locationFilter: '位置筛选（可选）',
      anyLocation: '任意位置',
      schedulerAssigns: '调度器将分配给第一台空闲的 {{model}} 打印机',
      schedulerAssignsInLocation: '调度器将分配给 {{location}} 中第一台空闲的 {{model}} 打印机',
      ...
      inactive: '（未启用）',
      unknownModel: '未知型号',
      matched: '（{{matched}}/{{total}} 已匹配）',
      auto: '自动',
      hiddenPrinters_one: '已隐藏 {{count}} 台其他打印机（型号不同）—',
      hiddenPrinters_other: '已隐藏 {{count}} 台其他打印机（型号不同）—',
      showAll: '全部显示',
      showOnlyModel: '仅显示 {{model}} 打印机',
