export default {
  ...
  printModal: {
    ...
    helpAsap: 'Print will start as soon as the printer is idle.',
    ...
    helpQueue: 'Print will be staged but won\'t start automatically. Use the Start button to release it to the queue.',
    leftNozzle: 'L',
    rightNozzle: 'R',
