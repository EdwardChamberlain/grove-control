export default {
  ...
  maintenance: {
    ...
    logTab: 'Log',
    logDescription: 'Review completed maintenance, repairs, and faults',
    allPrinters: 'All printers',
    filterByPrinter: 'Filter by printer',
    filterByType: 'Filter by type',
    allLogEntries: 'All entries',
    scheduledLogs: 'Scheduled',
    unscheduledLogs: 'Unscheduled',
    addLogEntry: 'Add log entry',
    editLogEntry: 'Edit log entry',
    noLogEntries: 'No maintenance log entries',
    manualEntry: 'Manual record',
    scheduledEntry: 'Scheduled task',
    recordedBy: 'Recorded by',
    updatedBy: 'Updated by',
    printer: 'Printer',
    selectPrinter: 'Select a printer',
    entryTitle: 'Title',
    entryTitlePlaceholder: 'e.g., Replaced extruder',
    occurredAt: 'Occurred at',
    recordPrintHours: 'Print hours at maintenance (optional)',
    notes: 'Notes',
    saveLogEntry: 'Save log entry',
    loadMore: 'Load more',
    logEntryCreated: 'Maintenance log entry created',
    logEntryUpdated: 'Maintenance log entry updated',
    logEntryDeleted: 'Maintenance log entry deleted',
    deleteLogEntryTitle: 'Delete maintenance log entry?',
    deleteLogEntryMessage: 'Permanently delete "{{title}}"?',
    // Status
  ...
  settings: {
    ...
    manageInventoryDescription: 'Create, update, and delete spools and inventory records.',
    ...
    cameraNativeOnly: 'Native printer cameras',
    cameraNativeOnlyDescription: 'Live view and snapshots use the camera built into each supported Bambu printer. External and USB cameras are not supported.',
    ...
    oidc: {
      ...
      form: {
        ...
        defaultGroup: 'Default Group',
        defaultGroupDesc: 'Group assigned to auto-created users. Leave empty to create them without group-derived permissions.',
        defaultGroupNone: 'None (no permissions)',
        autologin: 'Autologin',
  ...
  locations: {
    ...
    confirmDeleteMessageWithSensors: 'Remove all Home Assistant sensors from this location before deleting it.',
  },
  ...
  printModal: {
    ...
    printerSelector: {
      ...
      noActivePrinters: 'No active printers available',
      anyModel: 'Any {{model}}',
      anyModelGeneric: 'Any model',
      specificPrinter: 'Specific Printer',
      targetModel: 'Target Model',
      selectModel: 'Select a model...',
      locationFilter: 'Location Filter (optional)',
      anyLocation: 'Any location',
      schedulerAssigns: 'Scheduler will assign to first available idle {{model}} printer',
      schedulerAssignsInLocation: 'Scheduler will assign to first available idle {{model}} printer in {{location}}',
