export default {
  ...
  maintenance: {
    ...
    logTab: 'Protokoll',
    logDescription: 'Abgeschlossene Wartungen, Reparaturen und Störungen prüfen',
    allPrinters: 'Alle Drucker',
    filterByPrinter: 'Nach Drucker filtern',
    filterByType: 'Nach Typ filtern',
    allLogEntries: 'Alle Einträge',
    scheduledLogs: 'Geplant',
    unscheduledLogs: 'Ungeplant',
    addLogEntry: 'Protokolleintrag hinzufügen',
    editLogEntry: 'Protokolleintrag bearbeiten',
    noLogEntries: 'Keine Wartungsprotokolleinträge',
    manualEntry: 'Manueller Eintrag',
    scheduledEntry: 'Geplante Aufgabe',
    recordedBy: 'Erfasst von',
    updatedBy: 'Zuletzt bearbeitet von',
    printer: 'Drucker',
    selectPrinter: 'Drucker auswählen',
    entryTitle: 'Titel',
    entryTitlePlaceholder: 'z. B. Extruder ersetzt',
    occurredAt: 'Aufgetreten am',
    recordPrintHours: 'Druckstunden bei Wartung (optional)',
    notes: 'Notizen',
    saveLogEntry: 'Protokolleintrag speichern',
    loadMore: 'Mehr laden',
    logEntryCreated: 'Wartungsprotokolleintrag erstellt',
    logEntryUpdated: 'Wartungsprotokolleintrag aktualisiert',
    logEntryDeleted: 'Wartungsprotokolleintrag gelöscht',
    deleteLogEntryTitle: 'Wartungsprotokolleintrag löschen?',
    deleteLogEntryMessage: '„{{title}}“ dauerhaft löschen?',
    // Status
  ...
  settings: {
    ...
    manageInventoryDescription: 'Spulen und Bestandseinträge anlegen, ändern und löschen.',
    ...
    cameraNativeOnly: 'Integrierte Druckerkameras',
    cameraNativeOnlyDescription: 'Live-Ansicht und Schnappschüsse verwenden die in jedem unterstützten Bambu-Drucker integrierte Kamera. Externe Kameras und USB-Kameras werden nicht unterstützt.',
    nativeCamera: 'Integrierte Kamera',
    ...
    oidc: {
      ...
      form: {
        ...
        defaultGroup: 'Standardgruppe',
        defaultGroupDesc: 'Gruppe für automatisch erstellte Benutzer. Leer lassen, um sie ohne gruppenbasierte Berechtigungen zu erstellen.',
        defaultGroupNone: 'Keine (keine Berechtigungen)',
  ...
  printModal: {
    ...
    queueItemUpdated: 'Warteschlangeneintrag aktualisiert',
    printerSelector: {
      reRead: 'Neu lesen',
      stateOffline: 'Offline',
      statePrinting: 'Druckt',
      statePreparing: 'Vorbereitung',
      statePaused: 'Pausiert',
      stateIdle: 'Bereit',
      stateFinished: 'Fertig',
      stateFailed: 'Fehlgeschlagen',
      noPrinters: 'Keine Drucker verfügbar',
      noActivePrinters: 'Keine aktiven Drucker verfügbar',
      anyModel: 'Beliebiger {{model}}',
      anyModelGeneric: 'Beliebiges Modell',
      ...
      schedulerAssigns: 'Der Planer weist den ersten freien {{model}}-Drucker zu',
      schedulerAssignsInLocation: 'Der Planer weist den ersten freien {{model}}-Drucker in {{location}} zu',
      ...
      inactive: '(inaktiv)',
      unknownModel: 'Unbekanntes Modell',
      matched: '({{matched}}/{{total}} zugeordnet)',
      auto: 'Auto',
      ...
      selectTargetModel: 'Zieldruckermodell auswählen',
    },
  },
