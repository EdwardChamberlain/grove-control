export default {
  ...
  printModal: {
    ...
    helpAsap: 'Der Druck startet, sobald der Drucker im Leerlauf ist.',
    ...
    helpQueue: 'Der Druck wird bereitgestellt, startet aber nicht automatisch. Verwenden Sie die Start-Schaltfläche, um ihn für die Warteschlange freizugeben.',
    leftNozzle: 'L',
    rightNozzle: 'R',
