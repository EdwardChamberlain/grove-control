export default {
  ...
  settings: {
    ...
    cameraNativeOnly: 'Yerleşik yazıcı kameraları',
    cameraNativeOnlyDescription: 'Canlı görüntü ve anlık görüntüler, desteklenen her Bambu yazıcının yerleşik kamerasını kullanır. Harici ve USB kameralar desteklenmez.',
    nativeCamera: 'Yerleşik kamera',
