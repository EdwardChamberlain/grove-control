export default {
  ...
  printers: {
    ...
    directUploadLibraryNote: 'Bu yükleme kuyruğa eklenir ve Dosya Yöneticisi’ne kaydedilmez.',
  ...
  maintenance: {
    ...
    settingsTab: 'Ayarlar',
    logTab: 'Günlük',
    logDescription: 'Tamamlanan bakımları, onarımları ve arızaları inceleyin',
    allPrinters: 'Tüm yazıcılar',
    filterByPrinter: 'Yazıcıya göre filtrele',
    filterByType: 'Türe göre filtrele',
    allLogEntries: 'Tüm kayıtlar',
    scheduledLogs: 'Planlı',
    unscheduledLogs: 'Plansız',
    addLogEntry: 'Günlük kaydı ekle',
    editLogEntry: 'Günlük kaydını düzenle',
    noLogEntries: 'Bakım günlüğünde kayıt yok',
    manualEntry: 'Manuel kayıt',
    scheduledEntry: 'Planlı görev',
    recordedBy: 'Kaydeden',
    updatedBy: 'Son düzenleyen',
    printer: 'Yazıcı',
    selectPrinter: 'Yazıcı seçin',
    entryTitle: 'Başlık',
    entryTitlePlaceholder: 'örn. Ekstrüder değiştirildi',
    occurredAt: 'Gerçekleşme zamanı',
    recordPrintHours: 'Bakım sırasında yazdırma saatleri (isteğe bağlı)',
    notes: 'Notlar',
    saveLogEntry: 'Günlük kaydını kaydet',
    loadMore: 'Daha fazla yükle',
    logEntryCreated: 'Bakım günlüğü kaydı oluşturuldu',
    logEntryUpdated: 'Bakım günlüğü kaydı güncellendi',
    logEntryDeleted: 'Bakım günlüğü kaydı silindi',
    deleteLogEntryTitle: 'Bakım günlüğü kaydı silinsin mi?',
    deleteLogEntryMessage: '"{{title}}" kalıcı olarak silinsin mi?',
    // Durum
  ...
  settings: {
    ...
    manageInventoryDescription: 'Makaraları ve envanter kayıtlarını oluştur, güncelle ve sil.',
    ...
    oidc: {
      ...
      form: {
        ...
        defaultGroup: 'Varsayılan Grup',
        defaultGroupDesc: 'Otomatik oluşturulan kullanıcılara atanan grup. Grup izinleri olmadan oluşturmak için boş bırakın.',
        defaultGroupNone: 'Yok (izin yok)',
  ...
  printModal: {
    ...
    queueItemUpdated: 'Kuyruk öğesi güncellendi',
    printerSelector: {
      reRead: 'Yeniden oku',
      stateOffline: 'Çevrimdışı',
      statePrinting: 'Yazdırılıyor',
      statePreparing: 'Hazırlanıyor',
      statePaused: 'Duraklatıldı',
      stateIdle: 'Boşta',
      stateFinished: 'Tamamlandı',
      stateFailed: 'Başarısız',
      noPrinters: 'Kullanılabilir yazıcı yok',
      noActivePrinters: 'Kullanılabilir etkin yazıcı yok',
      anyModel: 'Herhangi bir {{model}}',
      anyModelGeneric: 'Herhangi bir model',
      ...
      schedulerAssigns: 'Zamanlayıcı ilk boştaki {{model}} yazıcıya atayacak',
      schedulerAssignsInLocation: 'Zamanlayıcı {{location}} konumundaki ilk boştaki {{model}} yazıcıya atayacak',
      selectPrinters: 'Yazıcıları seçin',
      ...
      unknownModel: 'Bilinmeyen model',
      matched: '({{matched}}/{{total}} eşleşti)',
      auto: 'Otomatik',
      hiddenPrinters_one: '{{count}} diğer yazıcı gizli (farklı model) —',
      hiddenPrinters_other: '{{count}} diğer yazıcı gizli (farklı model) —',
      showAll: 'tümünü göster',
      showOnlyModel: 'Yalnızca {{model}} yazıcılarını göster',
      selectAtLeastOnePrinter: 'En az bir yazıcı seçin',
      selectTargetModel: 'Hedef yazıcı modelini seçin',
    },
  },
  ...
  virtualPrinter: {
    ...
    mode: {
      title: 'Mod',
      archive: 'Dosyalar',
      archiveDesc: 'Yüklemeleri Dosyalar\'a kaydet',
      review: 'İnceleme',
      reviewDesc: 'Yüklemeleri Dosyalar\'a kaydetmeden önce incele',
      queue: 'Kuyruk',
      queueDesc: 'Yüklemeleri yazdırma kuyruğuna ekle',
      proxy: 'Proxy',
    ...
    archiveNameSource: {
      title: 'Yükleme görüntüleme adı',
      description: 'Yüklemelerin inceleme listesinde nasıl görüneceğini seçin. “Meta veriler” 3MF içine gömülü başlığı, “Dosya adı” FTP ile alınan dosya adını kullanır.',
      metadata: 'Meta veri',
      filename: 'Dosya adı',
    },
    caCert: {
    ...
    howItWorks: {
      ...
      step2: 'Dosyalar, İnceleme ve Kuyruk modlarında 3MF dosyalarını Grove Control’e yüklemek için dilimleyicinizdeki “Gönder” düğmesini kullanın. Dosyalar modu dosyaları kaydeder, İnceleme modu kaydetme veya silme seçeneği sunar, Kuyruk modu yazdırma işleri ekler. “Baskı başarılı” yüklemenin tamamlandığı anlamına gelir.',
