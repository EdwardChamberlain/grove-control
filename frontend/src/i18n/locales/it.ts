export default {
  ...
  printModal: {
    ...
    helpAsap: 'La stampa partirà appena la stampante è inattiva.',
    ...
    helpQueue: 'La stampa verrà preparata ma non partirà automaticamente. Usa il pulsante Avvia per rilasciarla nella coda.',
    leftNozzle: 'L',
    rightNozzle: 'R',
