export default {
  ...
  maintenance: {
    ...
    logTab: 'Registro',
    logDescription: 'Rivedi manutenzioni completate, riparazioni e guasti',
    allPrinters: 'Tutte le stampanti',
    filterByPrinter: 'Filtra per stampante',
    filterByType: 'Filtra per tipo',
    allLogEntries: 'Tutte le voci',
    scheduledLogs: 'Programmato',
    unscheduledLogs: 'Non programmato',
    addLogEntry: 'Aggiungi voce al registro',
    editLogEntry: 'Modifica voce del registro',
    noLogEntries: 'Nessuna voce nel registro manutenzione',
    manualEntry: 'Registrazione manuale',
    scheduledEntry: 'Attività programmata',
    recordedBy: 'Registrato da',
    updatedBy: 'Ultima modifica di',
    printer: 'Stampante',
    selectPrinter: 'Seleziona una stampante',
    entryTitle: 'Titolo',
    entryTitlePlaceholder: 'es. Estrusore sostituito',
    occurredAt: 'Data e ora',
    recordPrintHours: 'Ore di stampa alla manutenzione (facoltativo)',
    notes: 'Note',
    saveLogEntry: 'Salva voce',
    loadMore: 'Carica altro',
    logEntryCreated: 'Voce di manutenzione creata',
    logEntryUpdated: 'Voce di manutenzione aggiornata',
    logEntryDeleted: 'Voce di manutenzione eliminata',
    deleteLogEntryTitle: 'Eliminare la voce di manutenzione?',
    deleteLogEntryMessage: 'Eliminare definitivamente "{{title}}"?',
    // Status
  ...
  settings: {
    ...
    manageInventoryDescription: 'Crea, aggiorna ed elimina bobine e voci di inventario.',
    ...
    cameraNativeOnly: 'Fotocamere integrate della stampante',
    cameraNativeOnlyDescription: 'La visualizzazione live e le istantanee utilizzano la fotocamera integrata in ogni stampante Bambu supportata. Le fotocamere esterne e USB non sono supportate.',
    nativeCamera: 'Fotocamera integrata',
    ...
    oidc: {
      ...
      form: {
        ...
        defaultGroup: 'Gruppo predefinito',
        defaultGroupDesc: 'Gruppo assegnato agli utenti creati automaticamente. Lascia vuoto per crearli senza permessi derivati dai gruppi.',
        defaultGroupNone: 'Nessuno (nessun permesso)',
  ...
  fileManager: {
    ...
    singleFilePrompt: 'Rilascia un file qui',
    selectOneFile: 'Seleziona un file alla volta',
  ...
  // Print modal
  printModal: {
    directUploadRetained: 'Il file rimarrà in Gestione file perché viene usato per più stampe.',
    variants: {
    ...
    queueItemUpdated: 'Elemento della coda aggiornato',
    printerSelector: {
      reRead: 'Rileggi',
      stateOffline: 'Offline',
      statePrinting: 'In stampa',
      statePreparing: 'Preparazione',
      statePaused: 'In pausa',
      stateIdle: 'Inattiva',
      stateFinished: 'Completata',
      stateFailed: 'Non riuscita',
      noPrinters: 'Nessuna stampante disponibile',
      noActivePrinters: 'Nessuna stampante attiva disponibile',
      anyModel: 'Qualsiasi {{model}}',
      anyModelGeneric: 'Qualsiasi modello',
      specificPrinter: 'Stampante specifica',
      targetModel: 'Modello di destinazione',
      selectModel: 'Seleziona un modello...',
      locationFilter: 'Filtro posizione (facoltativo)',
      anyLocation: 'Qualsiasi posizione',
      schedulerAssigns: 'Lo scheduler assegnerà la prima stampante {{model}} libera',
      schedulerAssignsInLocation: 'Lo scheduler assegnerà la prima stampante {{model}} libera in {{location}}',
      ...
      inactive: '(inattiva)',
      unknownModel: 'Modello sconosciuto',
      matched: '({{matched}}/{{total}} corrispondenti)',
      auto: 'Auto',
      ...
      showOnlyModel: 'Mostra solo stampanti {{model}}',
      selectAtLeastOnePrinter: 'Seleziona almeno una stampante',
