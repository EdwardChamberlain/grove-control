export default {
  ...
  maintenance: {
    ...
    settingsTab: '設定',
    logTab: 'ログ',
    logDescription: '完了したメンテナンス、修理、故障を確認',
    allPrinters: 'すべてのプリンター',
    filterByPrinter: 'プリンターで絞り込む',
    filterByType: '種類で絞り込む',
    allLogEntries: 'すべての記録',
    scheduledLogs: '定期',
    unscheduledLogs: '臨時',
    addLogEntry: 'ログエントリを追加',
    editLogEntry: 'ログエントリを編集',
    noLogEntries: 'メンテナンスログはありません',
    manualEntry: '手動記録',
    scheduledEntry: '定期タスク',
    recordedBy: '記録者',
    updatedBy: '最終編集者',
    printer: 'プリンター',
    selectPrinter: 'プリンターを選択',
    entryTitle: 'タイトル',
    entryTitlePlaceholder: '例：エクストルーダーを交換',
    occurredAt: '発生日時',
    recordPrintHours: 'メンテナンス時の印刷時間（任意）',
    notes: 'メモ',
    saveLogEntry: 'ログエントリを保存',
    loadMore: 'さらに読み込む',
    logEntryCreated: 'メンテナンスログを作成しました',
    logEntryUpdated: 'メンテナンスログを更新しました',
    logEntryDeleted: 'メンテナンスログを削除しました',
    deleteLogEntryTitle: 'メンテナンスログを削除しますか？',
    deleteLogEntryMessage: '「{{title}}」を完全に削除しますか？',
    // Status
  ...
  settings: {
    ...
    manageInventoryDescription: 'スプールと在庫レコードの作成、更新、削除。',
    libraryBadge: 'ライブラリ',
    inventoryBadge: '在庫',
    ...
    cameraNativeOnly: 'プリンター内蔵カメラ',
    cameraNativeOnlyDescription: 'ライブビューとスナップショットには、対応する各Bambuプリンターに内蔵されたカメラを使用します。外部カメラとUSBカメラはサポートされていません。',
    nativeCamera: '内蔵カメラ',
    ...
    oidc: {
      ...
      form: {
        ...
        defaultGroup: 'デフォルトグループ',
        defaultGroupDesc: '自動作成ユーザーに割り当てるグループ。空欄にするとグループ由来の権限なしで作成されます。',
        defaultGroupNone: 'なし（権限なし）',
        autologin: '自動サインイン',
  ...
  printModal: {
    ...
    queueItemUpdated: 'キューのアイテムを更新しました',
    printerSelector: {
      reRead: '再読み込み',
      stateOffline: 'オフライン',
      statePrinting: '印刷中',
      ...
      stateFinished: '完了',
      stateFailed: '失敗',
      noPrinters: '利用可能なプリンターがありません',
      noActivePrinters: '利用可能なアクティブなプリンターがありません',
      anyModel: '任意の {{model}}',
      anyModelGeneric: '任意のモデル',
      specificPrinter: '特定のプリンター',
      targetModel: '対象モデル',
      selectModel: 'モデルを選択...',
      locationFilter: '場所フィルター（任意）',
      anyLocation: '任意の場所',
      schedulerAssigns: 'スケジューラーが最初に空いた {{model}} プリンターに割り当てます',
      schedulerAssignsInLocation: 'スケジューラーが {{location}} で最初に空いた {{model}} プリンターに割り当てます',
      selectPrinters: 'プリンターを選択',
      printersSelected_one: '{{count}} 台のプリンターを選択中',
      printersSelected_other: '{{count}} 台のプリンターを選択中',
      selectAll: 'すべて選択',
      clear: 'クリア',
      inactive: '（非アクティブ）',
      unknownModel: '不明なモデル',
      matched: '（{{matched}}/{{total}} 一致）',
      auto: '自動',
      hiddenPrinters_one: '他の {{count}} 台のプリンターを非表示（別モデル） —',
      hiddenPrinters_other: '他の {{count}} 台のプリンターを非表示（別モデル） —',
      showAll: 'すべて表示',
