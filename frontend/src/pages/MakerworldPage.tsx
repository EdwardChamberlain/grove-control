...
// use Grove Control's thumbnail proxy. MakerWorld summaries are authored HTML and
// commonly contain ``<img src="https://makerworld.bblmw.com/...">`` tags;
// Grove Control's img-src CSP only allows ``'self' data: blob:``, so these would
...
// MakerWorld CDN images can't be hotlinked — Grove Control's img-src CSP blocks
          ...
          <CardContent>
            <div className="grid gap-3">
              {instances.map((inst, idx) => {
                ...
                // — Grove Control can't actually re-slice across printers, but
