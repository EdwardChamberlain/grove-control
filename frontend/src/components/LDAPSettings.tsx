              ...
              <div className="flex items-start gap-3">
                ...
                <div className="space-y-2">
                  ...
                  <ul className="text-sm text-green-300 space-y-1 list-disc list-inside">
                    ...
                    <li>{t('settings.ldap.feature3') || 'LDAP groups are mapped to Grove Control groups on login'}</li>
                  </ul>
                </div>
              </div>
            </div>
            ...
            >
              <div className="space-y-3">
                ...
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-xs text-bambu-gray mt-0.5">
                      {t('settings.ldap.autoProvisionHint') || 'Automatically create a Grove Control account on first LDAP login'}
                    </p>
                  </div>
                  <button
                ...
                <div>
                  ...
                  />
                  <p className="text-xs text-bambu-gray mt-1">
                    {t('settings.ldap.groupMappingHint') || 'Map LDAP group DNs to Grove Control groups. Available groups: '}{groups.map(g => g.name).join(', ')}
                  </p>
                </div>
              </div>
            </Collapsible>
