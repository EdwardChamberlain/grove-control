            ...
            <div>
              ...
              <div className="flex gap-2">
                <div className="relative flex-1">
                  ...
                  {isCalendarOpen && (
                    <div ref={calendarRef} role="dialog" aria-label={t('printModal.chooseDate', 'Choose date')} className="absolute left-0 top-full z-30 mt-2 w-72 rounded-xl border border-bambu-dark-tertiary bg-bambu-dark-secondary p-3 shadow-xl">
