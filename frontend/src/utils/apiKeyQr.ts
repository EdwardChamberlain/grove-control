 ...
 *
 * The QR encodes the Grove Control base URL and the freshly-created API key together
 ...
 *
 * @param baseUrl Origin a client uses to reach Grove Control (origin only, no path).
