...
# but tuned to Grove Control's conventions — every actual directory variable in the
...
# don't need scrutiny — they're constructed by Grove Control code, not by the request.
