...
class TestModelBased:
    def _finder(self):
        """Stand-in matcher that respects the unavailable-printer set, as the
        real one does. The scheduler passes the union of active reservations
        and Home Assistant interlocks to the matcher.
        """
