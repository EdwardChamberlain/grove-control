...
_PUBLIC_ROUTES: frozenset[tuple[str, str]] = frozenset(
    {
        ...
        # MakerWorld thumbnail proxy — fetches external URL; no Grove Control data exposed.
        ...
        # Current Grove Control version — public info (already visible in HTTP response headers + Docker tags).
