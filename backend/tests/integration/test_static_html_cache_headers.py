...
Reproduced in the wild during the #1133 rollout — a kiosk display
kept serving the pre-fix picker for hours after every
...
HTML_ROUTES = [
    ...
    # Catch-all routes a nested SPA path to index.html. The trailing
    ...
    pytest.param("/kiosk/", id="spa-catchall-kiosk"),
