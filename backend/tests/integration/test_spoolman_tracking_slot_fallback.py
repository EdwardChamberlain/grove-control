...
Without this, tag-less spools assigned via the Grove Control UI never get their
...
class TestSlotAssignmentFallback:
    async def test_falls_back_to_slot_assignment_when_tag_missing(self, test_printer, mock_spoolman_client, db_session):
        """Tag-less spool assigned via Grove Control UI: extra.tag is empty (find_spool_by_tag
