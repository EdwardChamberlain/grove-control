...
async def slice_library_file(
    ...
    # GET on that id returned 404. Enforce the same visibility the read routes
    # use before reading the source off disk.
    ...
    # Fall back to the API key's owner so cloud-preset resolution can read the
    # stored cloud_token (#1182 follow-up).
