...
_PUBLIC_REPO_ERROR = (
    "Refusing to save: the target repository is not private. Grove Control backups "
...
_UNKNOWN_VISIBILITY_ERROR = (
    ...
    "Grove Control backups contain credentials and must never go to a public or "
...
async def save_config(
    ...
    The target repository must be private — Grove Control backups carry MQTT
