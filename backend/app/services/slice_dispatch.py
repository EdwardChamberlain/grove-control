...
class SliceJob:
    ...
    source_id: int
    source_name: str
    # User id that started the job, for per-row scoping of the polling
    # endpoint. None for unauthenticated callers; those jobs are visible only
    # to READ_ALL pollers — see slice_jobs.py.
