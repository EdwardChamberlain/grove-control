...
# but they're not exposed past the LAN edge; Grove Control's VPs sometimes are
    ...
    async def _send_status_report(
        ...
        try:
            ...
            if isinstance(cached, dict):
                ...
                # For VP usage the slicer uploads via FTPS to Grove Control's filesystem —
        ...
        try:
            ...
            if "print" in data:
                ...
                if command in ("project_file", "gcode_file"):
                    # File lives on Grove Control, not the printer — synthetic only.
