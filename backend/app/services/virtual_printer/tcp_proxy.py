...
between slicer and printer. Only MQTT is TLS-terminated so Grove Control can
...
class TLSProxy:
    ...
    to Grove Control's certificate while Grove Control connects to the real printer.
    """
