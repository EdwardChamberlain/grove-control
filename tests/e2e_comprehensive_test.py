...
BASE_URL = os.environ.get("GROVE_CONTROL_URL", "http://localhost:8000")
...
def test_navigation_and_sidebar(page):
    ...
    page.screenshot(path="/tmp/grove_control_home.png", full_page=True)
...
def test_printers_page(page):
    ...
    # Take screenshot
    page.screenshot(path="/tmp/grove_control_printers.png", full_page=True)
...
def test_archives_page(page):
    ...
    # Take screenshot
    page.screenshot(path="/tmp/grove_control_archives.png", full_page=True)
...
def test_queue_page(page):
    ...
    # Take screenshot
    page.screenshot(path="/tmp/grove_control_queue.png", full_page=True)
...
def test_statistics_page(page):
    ...
    # Take screenshot
    page.screenshot(path="/tmp/grove_control_statistics.png", full_page=True)
...
def test_settings_page(page):
    ...
    # Take screenshot
    page.screenshot(path="/tmp/grove_control_settings.png", full_page=True)
...
def test_keyboard_shortcuts(page):
    ...
    if modal.is_visible():
        ...
        page.screenshot(path="/tmp/grove_control_shortcuts_modal.png")
...
def test_responsive_design(page):
    ...
    for name, width, height in viewports:
        ...
        page.screenshot(path=f"/tmp/grove_control_{name.lower()}.png", full_page=True)
...
def run_comprehensive_test():
    ...
    print("=" * 60)
    print("GROVE CONTROL COMPREHENSIVE E2E TEST")
    print("=" * 60)
    ...
    with sync_playwright() as p:
        ...
        for test_name, test_func in tests:
            try:
                ...
                page.screenshot(path=f"/tmp/grove_control_error_{test_name.lower().replace(' ', '_')}.png")
    ...
    print("Screenshots saved to /tmp/grove_control_*.png")
