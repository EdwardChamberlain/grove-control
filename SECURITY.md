...
The Grove Control team takes security seriously. We appreciate your efforts to responsibly disclose your findings.
...
- **Affected versions** of Grove Control
...
Grove Control communicates with your printers over your local network using:
...
1. **Run on trusted network**: Grove Control should only be accessible on your local network
...
Anywhere a Grove Control code path joins a string from outside the function's
...
the routes verbatim and from external sources Grove Control has no control
...
Thank you for helping keep Grove Control and its users safe!
